      ...
      <div className="space-y-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-slate-500 font-medium">Manage all incoming 3D printing requests</p>
          </div>
          <button
        ...
        <div className="grid grid-cols-1 gap-6">
          {isLoading ? (
              ...
              filteredRequests.map((request) => (
                  ...
                  >
                    ...
                    <div className="flex flex-wrap items-center gap-3 pt-4 border-t border-slate-100">
                      <p className="text-xs font-black text-slate-400 uppercase tracking-widest mr-2">Update Status:</p>
                      <button
              ...
              <div className="text-center py-20 bg-slate-100/50 rounded-3xl border border-dashed border-slate-300">
                <p className="text-slate-400 font-bold text-xl">{showArchive ? 'Archive is empty' : 'No requests in queue'}</p>
                <p className="text-slate-400 font-medium">{showArchive ? 'Old requests will appear here' : 'New requests will appear here'}</p>
              </div>
          )}
        </div>
      </div>
